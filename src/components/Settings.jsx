...
const Settings = () => {
  ...
  return (
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:text-gray-200 text-gray-600 bg-white dark:bg-gray-800 w-400'>
        <div className='flex justify-between items-center p-4 l-4'>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
          ...
          <div className='mt-4'>
            ...
            <lable htmlFor='light' className='ml-2 text-md cursor-pointer'>Light</lable>
          </div>
          <div className='mt-4'>
            <input type='radio' id='dark' name='theme' value='Dark' className='cursor-pointer' onChange={setMode} checked={currentMode === 'Dark'}/>
            <lable htmlFor='dark' className='ml-2 text-md cursor-pointer'>Dark</lable>
          </div>
        </div>
